...
$sql = "SELECT id, First_Name, Last_Name, Birthday_day, Birthday_Month, Birthday_Year, Email_Id, Mobile_Number, Gender, Address, City, Pin_Code, State, Contry_Name, ClassX_Board, ClassX_Percentage, ClassX_YrOfPassing, ClassXII_Board, ClassXII_Percentage, ClassXII_YrOfPassing, Graduation_Board, Graduation_Percentage, Graduation_YrOfPassing, Masters_Board, Masters_Percentage, Masters_YrOfPassing, Course from registration";
$result = $conn->query($sql);

if ($result->num_rows>0){
while ($row = $result-> fetch_assoc()) {
echo "<tr><td>". $row["id"] ."</td><td>". $row["First_Name"] ."</td><td>". $row["Last_Name"] ."</td><td>". $row["Birthday_day"] ."</td><td>". $row["Birthday_Month"] ."</td><td>". $row["Birthday_Year"] ."</td><td>". $row["Email_Id"] ."</td><td>". $row["Mobile_Number"] ."</td><td>". $row["Gender"] ."</td><td>". $row["Address"] ."</td><td>". $row["City"] ."</td><td>". $row["Pin_Code"] ."</td><td>". $row["State"] ."</td><td>". $row["Contry_Name"] ."</td><td>". $row["ClassX_Board"] ."</td><td>". $row["ClassX_Percentage"] ."</td><td>". $row["ClassX_YrOfPassing"] ."</td><td>". $row["ClassXII_Board"] ."</td><td>". $row["ClassXII_Percentage"] ."</td><td>". $row["ClassXII_YrOfPassing"] ."</td><td>". $row["Graduation_Board"] ."</td><td>". $row["Graduation_Percentage"] ."</td><td>". $row["Graduation_YrOfPassing"] ."</td><td>". $row["Masters_Board"] ."</td><td>". $row["Masters_Percentage"] ."</td><td>". $row["Masters_YrOfPassing"] ."</td><td>". $row["Course"] ."</td><td>";
}
echo "</table>";
}
else {
